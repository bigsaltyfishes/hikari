...
use crate::hal::memory::table::GenericPTE;
...
impl VmHAL for VmHALImpl {
    ...
    fn map_kernel_space(table_addr: PhysicalAddress, kernel_table_addr: PhysicalAddress) {
        ...
        let dst_table = unsafe { core::slice::from_raw_parts_mut(hal::memory::utils::implement::phys_to_virt(table_addr) as *mut X86PTE, 512) };
        let src_table = unsafe { core::slice::from_raw_parts(hal::memory::utils::implement::phys_to_virt(kernel_table_addr) as *const X86PTE, 512) };
